            ...
            <div class="login-wrap p-4 p-md-5">
              ...
              <form v-if="step === 1" class="signin-form" @submit.prevent="sendCode">
                <div class="form-group mb-3">
                  <label class="label" for="text">用户名</label>
                  <input type="username" class="form-control" placeholder="请输入注册用户名" id="email" v-model="form.username"
                    required />
                </div>
                <div class="form-group mb-3">
              ...
              <form v-else class="signin-form" @submit.prevent="resetPassword">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="请输入邮箱收到的验证码" id="code" v-model="form.code"
                    required />
                </div>
                <div class="form-group mb-3">
